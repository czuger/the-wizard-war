...
\
    ...
    <div id="magical-item-xephis-icon-p${id}" class="magical-item-xephis laboratory-icon"></div>\
\
    <div id="magical-item-yaboul-count-p${id}" class="laboratories-amount">${yaboul_in_stock}</div>\
    <div id="magical-item-yaboul-icon-p${id}" class="magical-item-yaboul laboratory-icon"></div>\
</div>';
