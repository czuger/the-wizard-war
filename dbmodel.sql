...
ALTER TABLE player ADD toratsa_in_production TINYINT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE player ADD xephis_in_production TINYINT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE player ADD yaboul_in_production TINYINT UNSIGNED NOT NULL DEFAULT 0;
...
CREATE TABLE IF NOT EXISTS fanatics (
  internal_code INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
